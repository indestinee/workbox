...
hi SyntasticErrorSign term=bold ctermfg=Red cterm=bold
hi SyntasticError term=standout cterm=underline,bold ctermfg=Red
hi SyntasticWarningSign term=bold ctermfg=172 cterm=bold
hi SyntasticWarning term=standout cterm=underline,bold ctermfg=172
